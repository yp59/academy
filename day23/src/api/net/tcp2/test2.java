...
public class test2 {
	 ...
	 public static void main(String[] args){
	        ...
	        try{
	            Socket soc = new Socket("127.0.0.1",30000); //127.0.0.1은 루프백 아이피로 자신의 아이피를 반환해주고,
	            ...
	            while(true){
	                File filename = new File("test.kh");
	            fin = new FileInputStream(filename); //FileInputStream - 파일에서 입력받는 스트림을 개통합니다.
